...
class ReportViewHandler : public QObject
{
Q_OBJECT
...
private:
	...
	QList< ReportRowViewHandler* >* rowViewHandlers;

	void setupObject( QTableWidget* tableWidget );
    void freeRowHandlers();
